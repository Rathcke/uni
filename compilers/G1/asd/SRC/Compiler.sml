                         ...
                         *  but instead moving args back to registers. **)
                          and putArgsBack [] vtable reg = []
                            | putArgsBack  es vtable reg=
                              let  val t1 = (counter := !counter - 1;"_funarg__" ^ Int.toString(!counter)^"_") 
          ...
          and compileLVal( vtab : VTab, Var (n,_) : LVAL, pos : Pos ) : Mips.mips list * Location =
            ...
            | compileLVal( vtab : VTab, Index ((n,Array(r,btp)),inds) : LVAL, pos : Pos ) =
                case SymTab.lookup n vtab of 
                  SOME memAdr =>
                       ...
                       in  ([Mips.ADD(acc,acc,exp_reg), Mips.LW(strd_reg,memAdr,"0")]
                            ...
                            @ [Mips.ADD(acc,acc,strd_reg)], Reg acc)

                       end
                  | _ => raise Error( "indexed variables UNIMPLEMENTED, at ", pos)
              ...
              case s of
                ...
                | ProcCall ((n,_), es, p) => 
                  let
                      ...
                      val (mvbcode) = putArgsBack mvcode vtable maxreg
                  in
