...
\\000\000\000\000\002\000\000\000\001\000";

val yydgoto = "\002\000\
\\004\000";

val yysindex = "\255\255\
\\255\254\000\000\000\000\001\255\000\000";
...
val YYTABLESIZE = 3;
val yytable = "\001\000\
\\003\000\005\000\003\000";

val yycheck = "\001\000\
\\002\001\001\001\000\000";

val yyact = vector_ 4 (fn () => ((raise Fail "parser") : obj));
(* Rule 1, file 3a.grm, line 50 *)
...
val yytables : parseTables =
  ( yyact,
    ...
    yytable,
    yycheck );
fun A lexer lexbuf = yyparse yytables 1 lexer lexbuf;
(* Line 54, file 3a.grm *)
