...
reaImages = loadMNISTImages('t10k-images-idx3-ubyte');
...
r01 = reaImages(:,[r0_idx(1:500);r1_idx(1:500)]);
r08 = reaImages(:,[r0_idx(1:500);r8_idx(1:500)]);
r56 = reaImages(:,[r5_idx(1:500);r6_idx(1:500)]);
%% Q4.1 01
C = [10^-6,10^-5,10^-4,10^-3,10^-2,10^-1,1,10,100];
clf;
[Wcard, E_test, E_in] = soft_svm_v2(t01_250,250,real_01);
subplot(3,1,1)
plotyy(C, [E_in ; E_test], C, Wcard, 'semilogx');
legend('E_{in}','E_{test}','|w|');

[Wcard, E_test, E_in] = soft_svm_v2(t01_500,500,real_01);
subplot(3,1,2)
plotyy(C, [E_in ; E_test], C, Wcard, 'semilogx');

[Wcard, E_test, E_in] = soft_svm_v2(t01_1000,1000,real_01);
subplot(3,1,3)
plotyy(C, [E_in ; E_test], C, Wcard, 'semilogx');

%% 08
clf;
[Wcard, E_test, E_in] = soft_svm_v2(t56_250,250,real_01);
subplot(3,1,1)
plotyy(C, [E_in ; E_test], C, Wcard, 'semilogx');
legend('E_{in}','E_{test}','|w|');
[Wcard, E_test, E_in] = soft_svm_v2(t56_500,500,real_01);
subplot(3,1,2)
plotyy(C, [E_in ; E_test], C, Wcard, 'semilogx');

[Wcard, E_test, E_in] = soft_svm_v2(t56_1000,1000,real_01);
subplot(3,1,3)
plotyy(C, [E_in ; E_test], C, Wcard, 'semilogx');
