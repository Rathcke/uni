...
<HTML>
<HEAD>
<link rel="stylesheet" type="text/css" href="static/barbarbar.css">
<TITLE><?php echo "$page_title - " ?>BarbarBar Foundation
</TITLE>
</HEAD>
<div id="header">
<div>DIKU PCS 2016</div>
...
<?php
  ...
  $concepts = array( "21st century", "next generation",
                     "new world order", "United States", "Proud Denmark",
  ...
  echo "<h1><a href='index.php'>BarbarBar Foundation for " .
       "$adjective $noun</a></h1>";
